...
CELERY_BROKER_URL = f"redis://{os.getenv('REDIS_PASSWORD', None)}@{os.getenv('REDIS_HOST', '127.0.0.1')}:{os.getenv('REDIS_PORT', '6379')}/0"

# backend配置，这里使用redis
CELERY_RESULT_BACKEND = f"redis://{os.getenv('REDIS_PASSWORD', None)}@{os.getenv('REDIS_HOST', '127.0.0.1')}:{os.getenv('REDIS_PORT', '6379')}/0"
